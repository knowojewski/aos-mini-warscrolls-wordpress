        ...
        if (0 === e.find("div.ui-timepicker-div").length && t.showTimepicker) {
          ...
          for (u = 0, c = this.units.length; u < c; u++) {
            if (
              ...
              (a = null !== t["show" + n] ? t["show" + n] : this.support[s]),
              (r[s] = parseInt(
                t[s + "Max"] - ((t[s + "Max"] - t[s + "Min"]) % t["step" + n]),
                10
              )),
              (l[s] = 0),
              (d +=
          ...
          (d +=
            ...
            t.timezoneText +
            "</dt>"),
            (d += '<dd class="ui_tpicker_timezone' + (_ ? "" : m) + '"></dd>'),
            (d += "</dl></div>");
          var g = $(d);
          for (
            t.timeOnly === !0 &&
                ...
                g
                  ...
                  .click(function (e) {
                    ...
                    "hour" === l &&
                      (r.indexOf("p") !== -1 && a < 12
                        ? (a += 12)
                        : r.indexOf("a") !== -1 && 12 === a && (a = 0)),
                      i.control.value(i, i[l + "_slider"], s, a),
                      i._onTimeChange(),
                      i._onSelectHandler();
                  })
                  .css({
        ...
        if (this._defaults.showTimepicker) {
          ...
          if (null !== e.settings.maxTime) {
            ...
            this.hour > u.getHours()
              ...
              : this.hour === u.getHours() && this.minute > u.getMinutes()
              ? (this.minute = this._defaults.minuteMax = u.getMinutes())
              : this._defaults.hourMax > u.getHours()
              ? ((this._defaults.hourMax = u.getHours()),
                (this._defaults.minuteMax = u.getMinutes()))
              : (this._defaults.hourMax === u.getHours()) === this.hour &&
                this._defaults.minuteMax > u.getMinutes()
              ? (this._defaults.minuteMax = u.getMinutes())
        ...
        if (this._defaults.showTimepicker) {
          ...
          var u = r[e < 12 ? "amNames" : "pmNames"][0],
            c =
              ...
              (null !== this.timezone && a !== this.timezone.toString());
          c &&
            (e !== !1 && (this.hour = e),
            t !== !1 && (this.minute = t),
            i !== !1 && (this.second = i),
            ...
            this.$timeObj &&
              (l === r.timeFormat
                ...
                : this.$timeObj.val($.datepicker.formatTime(l, this, r) + o)),
            (this.timeDefined = !0),
        ...
        slider: {
          create: function (e, t, i, s, n, a, r) {
            ...
            return t.prop("slide", null).slider({
              ...
              step: r,
              slide: function (t, s) {
                e.control.value(e, $(this), i, l ? s.value * -1 : s.value),
                  e._onTimeChange();
              },
              stop: function (t, i) {
                e._onSelectHandler();
        ...
        var s = extendRemove(extendRemove({}, $.timepicker._defaults), i || {}),
          ...
          a = function (e, t, i) {
            ...
            return (
                ...
                (void 0 === o[r.t] || 0 === o[r.t].length
                  ...
                  : ((l =
                      $.inArray(
                        ...
                        ? "AM"
                        : "PM"),
                    (u.ampm = i["AM" === l ? "amNames" : "pmNames"][0]))),
              r.h !== -1 &&
                ("AM" === l && "12" === o[r.h]
                  ? (u.hour = 0)
                  : "PM" === l && "12" !== o[r.h]
              ...
              r.z !== -1 &&
                void 0 !== o[r.z] &&
                (u.timezone = $.timepicker.timezoneOffsetNumber(o[r.z])),
              u)
            );
          },
          r = function (e, t, i) {
            ...
            (r += $.datepicker.formatTime(u, t, t._defaults) + o),
              t._defaults.timeOnly ||
                ...
                (r = t._defaults.altFormat
                  ? $.datepicker.formatDate(t._defaults.altFormat, n, a) + l + r
                  : t.formattedDate + l + r),
              $(i).val(e.input.val() ? r : "");
          }
          ...
          if (n) {
            ...
            t &&
              ("string" == typeof t
                ? (n._parseTime(t, i),
                  (a = new Date()),
                  a.setHours(n.hour, n.minute, n.second, n.millisec),
          ...
          s instanceof Date
            ...
            n &&
              ...
              (s = $.timepicker.timezoneAdjust(
                s,
                $.timepicker.timezoneOffsetString(-s.getTimezoneOffset()),
                n.timezone
              )),
              (a = $.timepicker.timezoneAdjust(
                a,
                $.timepicker.timezoneOffsetString(-a.getTimezoneOffset()),
                n.timezone
              ))),
            this._updateDatepicker(i),
            this._base_setDateDatepicker.apply(this, arguments),
            ...
            return (
              (a =
                s.$altInput && s._defaults.altFieldTimeOnly
                  ...
                  : "INPUT" !== s.$input.get(0).tagName && s.$altInput
                  ? s.$altInput.val()
                  : s.$input.val()),
              n &&
                s._parseTime(a, !i.settings.timeOnly) &&
                (n.setHours(s.hour, s.minute, s.second, s.millisec),
                n.setMicroseconds(s.microsec),
                null != s.timezone &&
                  (s.support.timezone ||
                    null !== s._defaults.timezone ||
                    (s.timezone = n.getTimezoneOffset() * -1),
                  (n = $.timepicker.timezoneAdjust(
                    n,
                    s.timezone,
                    $.timepicker.timezoneOffsetString(-n.getTimezoneOffset())
                  )))),
              n
            );
          }
      ...
      ($.datepicker.parseDate = function (e, t, i) {
        ...
        try {
          ...
          (s = this._base_parseDate(
            e,
            t.substring(0, t.length - (n.length - n.indexOf(":") - 2)),
            i
          )),
            $.timepicker.log(
      ...
      ($.datepicker._optionDatepicker = function (e, t, i) {
        ...
        if (a) {
          ...
          if ("string" == typeof t) {
            ...
            for (m in u) u.hasOwnProperty(m) && t[m] && (c[m] = t[m]);
          }
          for (m in c)
            c.hasOwnProperty(m) &&
              ((u[m] = c[m]), n || (n = $.extend({}, t)), delete n[m]);
        ...
        return void 0 === i
          ...
          : this._base_optionDatepicker.call($.datepicker, e, n || t, i);
      });
        ...
        function n(n, a) {
          ...
          if (null !== r) {
            ...
            u.setMilliseconds(u.getMilliseconds() + s.minInterval),
              c.setMilliseconds(c.getMilliseconds() + s.maxInterval),
              s.minInterval > 0 && u > l
                ? i[e]("setDate", u)
                : s.maxInterval > 0 && c < l
                ? i[e]("setDate", c)
        ...
        function a(t, i, n) {
          if (t.val()) {
            ...
            null !== a &&
              s.minInterval > 0 &&
              ("minDate" === n &&
                a.setMilliseconds(a.getMilliseconds() + s.minInterval),
              "maxDate" === n &&
                a.setMilliseconds(a.getMilliseconds() - s.minInterval)),
