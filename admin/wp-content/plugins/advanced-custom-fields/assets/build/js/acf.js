...
*/
  ...
  var removeDiv = function (props) {
    ...
    // wrap
    $el.wrap(
      '<div class="acf-temp-remove" style="height:' + outerHeight + 'px"></div>'
    );
    var $wrap = $el.parent();
  ...
  acf.rename = function (args) {
    ...
    if (args.destructive) {
      ...
      $el
        .find('[name*="' + args.search + '"]')
        .attr("name", withReplacer("name"));
    }
  ...
  var panel = new acf.Model({
    ...
    open: function ($el) {
      ...
      $el
        ...
        .attr("class", "dashicons dashicons-arrow-down");
    },
    ...
    close: function ($el) {
      ...
      $el
        .find(".acf-panel-title i")
        .attr("class", "dashicons dashicons-arrow-right");
    },
  });
})(jQuery);
(function ($, undefined) {
