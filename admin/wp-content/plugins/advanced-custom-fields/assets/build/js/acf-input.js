  ...
  var accordionManager = new acf.Model({
    ...
    open: function ($el) {
      ...
      $el
        ...
        .replaceWith(this.iconHtml({ open: true }));
      $el.addClass("-open");
    ...
    close: function ($el) {
      ...
      $el
        .find(".acf-accordion-icon:first")
        .replaceWith(this.iconHtml({ open: false }));
      $el.removeClass("-open");
        ...
        if (!postbox) {
          ...
          data.results.map(function (_result) {
            if (
              ...
              $("#" + result.position + "-sortables #" + _result.id).length
            ) {
  ...
  var fieldsHelper = new acf.Model({
    ...
    renderGroup: function ($el) {
      ...
      $fields.each(function (i) {
        ...
        if (acf.get("rtl")) {
          thisLeft = Math.ceil(
            $field.parent().width() - (position.left + $field.outerWidth())
          );
        }
